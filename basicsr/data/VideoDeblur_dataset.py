...
class DeblurRecurrentBSDDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(DeblurRecurrentBSDDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        for neighbor in neighbor_list:
            if self.is_lmdb:
                ...
                img_lq_path = self.lq_root / clip_name / f'{neighbor:08d}.{self.file_end}'
                img_gt_path = self.gt_root / clip_name / f'{neighbor:08d}.{self.file_end}'
        ...
        return {'lq': img_lqs, 'gt': img_gts, 'folder': clip_name}
