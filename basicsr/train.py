...
def load_resume_state(opt):
    ...
    """ resume_state['schedulers'][0]['periods'] = [100000,100000,100000,100000,100000,100000,100000,100000]
    resume_state['schedulers'][0]['restart_weights'] = [0.5,0.75,0.5,0.35,0.25,0.5,0.25,0.5]
    resume_state['schedulers'][0]['eta_mins'] = [[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7],[1.0e-7,1.0e-7]]
    resume_state['schedulers'][0]['cumulative_period'] = [100000,200000,300000,400000,500000,600000,700000,800000] """
    # resume_state['schedulers'][0]['periods'] = [20000,10000]
    # resume_state['schedulers'][0]['restart_weights'] = [0.09,0.045]
    # resume_state['schedulers'][0]['eta_mins'] = [[1.0e-7,1.0e-7],[1.0e-7,1.0e-7]]
    # resume_state['schedulers'][0]['cumulative_period'] = [20000,30000] 
    return resume_state
