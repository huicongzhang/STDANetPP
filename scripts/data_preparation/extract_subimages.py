...
def main():
    ...
    # HR images
    opt['input_folder'] = 'datasets/GoPro_large/test/GT'
    opt['save_folder'] = 'datasets/GoPro_large/test/GT_sub256'
    opt['crop_size'] = 512
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # HR images
    # opt['input_folder'] = 'datasets/GoPro_large/train/blur'
    # opt['save_folder'] = 'datasets/GoPro_large/train/blur_sub'
    # opt['crop_size'] = 480
    # opt['step'] = 240
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
